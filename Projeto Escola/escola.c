...
void aluno(estru_aluno e_aluno[], int qtdAluno, estru_professor e_professor[],
           int qtdProfessor, estru_disciplina e_disciplina[], int qtdDisciplina,
           int cont_alu_disc) {
  int opcao_1;
  ...
  scanf("%d", &opcao_1);
  if (opcao_1 == 1) {
    inc_aluno(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
              qtdDisciplina, cont_alu_disc);
  } else if (opcao_1 == 2) {
    exc_alun(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
             qtdDisciplina, cont_alu_disc);
  } else if (opcao_1 == 3) {
    atua_alun(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
              qtdDisciplina, cont_alu_disc);
  } else if (opcao_1 == 4) {
    alu_prof_disci(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                   qtdDisciplina, cont_alu_disc);
  } else {
    printf("Opção inválida.\n");
    aluno(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
          qtdDisciplina, cont_alu_disc);
  }
}
void professor(estru_aluno e_aluno[], int qtdAluno,
               estru_professor e_professor[], int qtdProfessor,
               estru_disciplina e_disciplina[], int qtdDisciplina,
               int cont_alu_disc) {
  int opcao_2;
  printf("\nDigite a opção que deseja realizar:\n");
  ...
  scanf("%d", &opcao_2);
  if (opcao_2 == 1) {
    inc_prof(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
             qtdDisciplina, cont_alu_disc);
  } else if (opcao_2 == 2) {
    exc_prof(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
             qtdDisciplina, cont_alu_disc);
  } else if (opcao_2 == 3) {
    atua_prof(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
              qtdDisciplina, cont_alu_disc);
  } else if (opcao_2 == 4) {
    alu_prof_disci(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                   qtdDisciplina, cont_alu_disc);
    ...
    printf("Opção inválida.\n");
    professor(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
              qtdDisciplina, cont_alu_disc);
  }
}
void disciplina(estru_aluno e_aluno[], int qtdAluno,
                estru_professor e_professor[], int qtdProfessor,
                estru_disciplina e_disciplina[], int qtdDisciplina,
                int cont_alu_disc) {
  int opcao_3;
  ...
  scanf("%d", &opcao_3);
  if (opcao_3 == 1) {
    inc_disc(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
             qtdDisciplina, cont_alu_disc);
  } else if (opcao_3 == 2) {
    exc_discip(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
               qtdDisciplina, cont_alu_disc);
  } else if (opcao_3 == 3) {
    atua_discip(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                qtdDisciplina, cont_alu_disc);
  } else if (opcao_3 == 4) {
    inse_alu_discip(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                    qtdDisciplina, cont_alu_disc);
  } else if (opcao_3 == 5) {
    exclu_alu_discip(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                     qtdDisciplina, cont_alu_disc);
  } else if (opcao_3 == 6) {
    alu_prof_disci(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                   qtdDisciplina, cont_alu_disc);
    ...
    printf("Opção inválida.\n");
    disciplina(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
               qtdDisciplina, cont_alu_disc);
  }
}

// INCLUIR CADASTROS
void inc_aluno(estru_aluno e_aluno[], int qtdAluno,
               estru_professor e_professor[], int qtdProfessor,
               estru_disciplina e_disciplina[], int qtdDisciplina,
               int cont_alu_disc) {
  getchar();
...
void inc_prof(estru_aluno e_aluno[], int qtdAluno,
              estru_professor e_professor[], int qtdProfessor,
              estru_disciplina e_disciplina[], int qtdDisciplina,
              int cont_alu_disc) {
  getchar();
...
void inc_disc(estru_aluno e_aluno[], int qtdAluno,
              estru_professor e_professor[], int qtdProfessor,
              estru_disciplina e_disciplina[], int qtdDisciplina,
              int cont_alu_disc) {
  getchar();
...
// EXCLUIR CADASTROS
void exc_alun(estru_aluno e_aluno[], int qtdAluno,
              estru_professor e_professor[], int qtdProfessor,
              estru_disciplina e_disciplina[], int qtdDisciplina,
              int cont_alu_disc) {
...
void exc_prof(estru_aluno e_aluno[], int qtdAluno,
              estru_professor e_professor[], int qtdProfessor,
              estru_disciplina e_disciplina[], int qtdDisciplina,
              int cont_alu_disc) {
  int matricula, cont = 0;
...
void exc_discip(estru_aluno e_aluno[], int qtdAluno,
                estru_professor e_professor[], int qtdProfessor,
                estru_disciplina e_disciplina[], int qtdDisciplina,
                int cont_alu_disc) {
  int codigo, cont = 0;
...
// ATUALIZAR CADASTROS
void atua_alun(estru_aluno e_aluno[], int qtdAluno,
               estru_professor e_professor[], int qtdProfessor,
               estru_disciplina e_disciplina[], int qtdDisciplina,
               int cont_alu_disc) {
  int matricula, cont = 0;
...
void atua_prof(estru_aluno e_aluno[], int qtdAluno,
               estru_professor e_professor[], int qtdProfessor,
               estru_disciplina e_disciplina[], int qtdDisciplina,
               int cont_alu_disc) {
  int matricula, cont = 0;
...
void atua_discip(estru_aluno e_aluno[], int qtdAluno,
                 estru_professor e_professor[], int qtdProfessor,
                 estru_disciplina e_disciplina[], int qtdDisciplina,
                 int cont_alu_disc) {
  int codigo, cont = 0;
...
void inse_alu_discip(estru_aluno e_aluno[], int qtdAluno,
                     estru_professor e_professor[], int qtdProfessor,
                     estru_disciplina e_disciplina[], int qtdDisciplina,
                     int cont_alu_disc) {
  int codigo, cont = 0;
...
void exclu_alu_discip(estru_aluno e_aluno[], int qtdAluno,
                      estru_professor e_professor[], int qtdProfessor,
                      estru_disciplina e_disciplina[], int qtdDisciplina,
                      int cont_alu_disc) {
  int codigo, cont;
...
// CHAMAR AS LISTAS
void relatorios(estru_aluno e_aluno[], int qtdAluno,
                estru_professor e_professor[], int qtdProfessor,
                estru_disciplina e_disciplina[], int qtdDisciplina,
                int cont_alu_disc) {
  int opcao_relat;
  ...
  printf(
      "1 - Listar alunos\n2 - Listar professores\n3 - Listar disciplinas(dados "
      "das disciplinas sem os alunos)\n4 - Listar uma disciplina(dados da "
      "disciplina e os alunos matriculados\n5 - Listar alunos por sexo(F/M)\n6 "
      "- Listar alunos ordenados por nome\n7 - Listar alunos ordenados por "
      "data de nascimento\n8 - Listar professores por sexo(F/M)\n9 - Listar "
      "professores ordenados por nome\n10 - Listar professores ordenados por "
      "data de nascimento\n11 - Voltar\n");
  scanf("%d", &opcao_relat);
  if (opcao_relat == 1) {
    lista_aluno(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                qtdDisciplina, cont_alu_disc);
  } else if (opcao_relat == 2) {
    lista_prof(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
               qtdDisciplina, cont_alu_disc);
  } else if (opcao_relat == 3) {
    lista_disciplina(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                     qtdDisciplina, cont_alu_disc);
  } else if (opcao_relat == 4) {
    lista_uma_disci(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                    qtdDisciplina, cont_alu_disc);
  } else if (opcao_relat == 5) {
    lista_aluno_sex(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                    qtdDisciplina, cont_alu_disc);
  } else if (opcao_relat == 6) {
    lista_aluno_nome(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                     qtdDisciplina, cont_alu_disc);
  } else if (opcao_relat == 7) {
    lista_aluno_nasci(e_aluno, qtdAluno, e_professor, qtdProfessor,
                      e_disciplina, qtdDisciplina, cont_alu_disc);
  } else if (opcao_relat == 8) {
    lista_prof_sex(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                   qtdDisciplina, cont_alu_disc);
  } else if (opcao_relat == 9) {
    lista_prof_nome(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                    qtdDisciplina, cont_alu_disc);
  } else if (opcao_relat == 10) {
    lista_prof_nasc(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
                    qtdDisciplina, cont_alu_disc);
    ...
    printf("Opção inválida.\n");
    relatorios(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
               qtdDisciplina, cont_alu_disc);
  }
}

// GERAÇÃO DAS LISTAS
void lista_prof_nasc(estru_aluno e_aluno[], int qtdAluno,
                     estru_professor e_professor[], int qtdProfessor,
                     estru_disciplina e_disciplina[], int qtdDisciplina,
                     int cont_alu_disc) {
  relatorios(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
...
void lista_prof_nome(estru_aluno e_aluno[], int qtdAluno,
                     estru_professor e_professor[], int qtdProfessor,
                     estru_disciplina e_disciplina[], int qtdDisciplina,
                     int cont_alu_disc) {
  relatorios(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
...
void lista_prof_sex(estru_aluno e_aluno[], int qtdAluno,
                    estru_professor e_professor[], int qtdProfessor,
                    estru_disciplina e_disciplina[], int qtdDisciplina,
                    int cont_alu_disc) {
...
void lista_aluno_nasci(estru_aluno e_aluno[], int qtdAluno,
                       estru_professor e_professor[], int qtdProfessor,
                       estru_disciplina e_disciplina[], int qtdDisciplina,
                       int cont_alu_disc) {
  relatorios(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
...
void lista_aluno_nome(estru_aluno e_aluno[], int qtdAluno,
                      estru_professor e_professor[], int qtdProfessor,
                      estru_disciplina e_disciplina[], int qtdDisciplina,
                      int cont_alu_disc) {
  relatorios(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
...
void lista_aluno_sex(estru_aluno e_aluno[], int qtdAluno,
                     estru_professor e_professor[], int qtdProfessor,
                     estru_disciplina e_disciplina[], int qtdDisciplina,
                     int cont_alu_disc) {
...
void lista_uma_disci(estru_aluno e_aluno[], int qtdAluno,
                     estru_professor e_professor[], int qtdProfessor,
                     estru_disciplina e_disciplina[], int qtdDisciplina,
                     int cont_alu_disc) {
  relatorios(e_aluno, qtdAluno, e_professor, qtdProfessor, e_disciplina,
...
void lista_disciplina(estru_aluno e_aluno[], int qtdAluno,
                      estru_professor e_professor[], int qtdProfessor,
                      estru_disciplina e_disciplina[], int qtdDisciplina,
                      int cont_alu_disc) {
...
void lista_prof(estru_aluno e_aluno[], int qtdAluno,
                estru_professor e_professor[], int qtdProfessor,
                estru_disciplina e_disciplina[], int qtdDisciplina,
                int cont_alu_disc) {
...
void lista_aluno(estru_aluno e_aluno[], int qtdAluno,
                 estru_professor e_professor[], int qtdProfessor,
                 estru_disciplina e_disciplina[], int qtdDisciplina,
                 int cont_alu_disc) {
  printf("\nLista de alunos:%d\n", qtdAluno);
...
void alu_prof_disci(estru_aluno e_aluno[], int qtdAluno,
                    estru_professor e_professor[], int qtdProfessor,
                    estru_disciplina e_disciplina[], int qtdDisciplina,
                    int cont_alu_disc) {
  int opcao;
  ...
  printf("1 - Adicionar/Modificar/Excluir - Aluno\n2 - "
         "Adicionar/Modificar/Excluir - Professor\n3 - "
         "Adicionar/Modificar/Excluir - Disciplina\n4 - Gerar Relatórios\n5 - "
         "Sair\n");
  scanf("%d", &opcao);
